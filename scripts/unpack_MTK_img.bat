...
:ziperror
echo(
ctext "{0C}Your ramdisk archive is corrupt. Are you trying to unpack a regular image with {0B}MTK{0C} script? If so, please use unpack_img script. Exit script.{07}{\n}"
echo(
goto end
::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
:noinput
